<template>
  <div class="multi_exec">
    ...
    <div style="margin-top: 10px;">
      <a-button @click="showModal" >从主机列表中选择</a-button>
            ...
            <a-row>
              <a-col :span="10">
                <a-form-item label="模板类别：" :label-col="formItemLayout.labelCol"
                  ...
                  <a-select style="width: 160px;" placeholder="请选择"  v-model="template_form.form.category"  @change="handleSelectChange2">
              ...
              <a-col :span="4">
                <a-button type="primary" style="margin-top: 3px;" @click="">刷新</a-button>
              </a-col>
            </a-row>
          </div>
          <div>
    ...
    <v-ace-editor
        ...
        style="height: 200px"/>
    <div>
      <a-button type="primary"  @click="execute_cmd">开始执行</a-button>
    </div>
...
// 计算属性
  ...
  methods: {
    ...
    ,
    has_change_tem_category(category) {
      // 切换主机分类时，重新获取主机列表
      this.get_templates_list(category)
    },
    refresh_data() {
      // 刷新数据
    ...
    execute_cmd() {
      ...
      axios.post(`${this.$settings.host}/mtask/cmd_exec`, {
        ...
        // console.log(res.data[0]['res_data']);
        this.exec_result = res.data[0]['res_data']
